...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/xkdzt/v2_ws_tls_bash/master/install.sh" && chmod +x install.sh && bash install.sh
```
...
证书文件: `/home/v2ray.key 和 /home/v2ray.crt` 请注意证书权限设置
